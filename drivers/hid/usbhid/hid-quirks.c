...
static const struct hid_blacklist {
	...
	{ USB_VENDOR_ID_ASUS_GAMEPAD,USB_DEVICE_ID_ASUS_GAMEPAD_III_LEFT,HID_QUIRK_SKIP_OUTPUT_REPORT_ID},
	{ USB_VENDOR_ID_ASUS_GAMEPAD,USB_DEVICE_ID_ASUS_GAMEPAD_III_HOLDER,HID_QUIRK_SKIP_OUTPUT_REPORT_ID},
