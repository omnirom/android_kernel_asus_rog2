...
static const struct hid_blacklist {
	...
	{ USB_VENDOR_ID_ASUS_GAMEPAD,USB_DEVICE_ID_ASUS_GAMEPAD,HID_QUIRK_SKIP_OUTPUT_REPORT_ID},
	{ USB_VENDOR_ID_ENE,USB_DEVICE_ID_ENE_6K7750_MAIN,HID_QUIRK_ALWAYS_POLL},
