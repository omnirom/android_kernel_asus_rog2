...
// Asus_SZ_BSP Sid : Asus DT hub node add +++
...
{
	dev_info(&udev->dev, "[USB] New USB device found, idVendor=%04x, idProduct=%04x\n",
...
extern uint8_t gDongleType;
extern int hid_to_get_ec_fw_ver(char* ver);
